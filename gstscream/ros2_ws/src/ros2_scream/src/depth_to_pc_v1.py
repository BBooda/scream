...
class DepthImageToPointCloud(Node):
    ...
    def depth_image_callback(self, msg):
        ...
        # return back to 2048x64
        depth_image = self.reverse_stacking(depth_image)
    ...
    def reverse_stacking(self, stacked_image):
        # Extract the first 64 rows (temp_a) and next 64 rows (temp_b)
        first_row = stacked_image[0:64, 128:1152]
        second_row = stacked_image[64:128, 128:1152]
