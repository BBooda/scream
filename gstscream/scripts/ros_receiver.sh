...
#            t. ! queue ! videoconvert ! video/x-raw,format=BGR ! appsink name=appsink0"
VIDEOSINK="tee name=t ! queue ! videoconvert ! fpsdisplaysink video-sink=\"ximagesink\" \
...
# VIDEOSINK="videoconvert ! video/x-raw,format=RGB ! jpegenc ! udpsink host=127.0.0.1 port=7000"
